...
from tools.custom_tool import TranscriptionTool
...
@CrewBase
class AiVideoAnalyser():
    """AiVideoAnalyser crew"""
    ...
    def transcription_task(self) -> Task:
        return Task(
            ...
            output_file='transcribed_file.txt',
        )
    ...
    def summary_task(self) -> Task:
        return Task(
            ...
            output_file='analysed_file.md'
        )

    @crew
    def crew(self) -> Crew:
        """Creates the AiVideoAnalyser crew"""
